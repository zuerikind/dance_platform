-- Run this ENTIRE block alone in Supabase SQL Editor (select all, then Run).
-- Then run: SELECT prosrc LIKE '%You don''t have enough classes in your package%' AS has_new_check FROM pg_proc WHERE proname = 'register_for_class';
