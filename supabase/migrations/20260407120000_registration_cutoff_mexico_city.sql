-- Registration / clase suelta: student calls may only target class_date on or after
-- "today" in America/Mexico_City (open until end of that calendar day). Admins bypass.
