-- Re-apply balance vs registered count logic (in case 20260307100000 was applied before the fix or failed partway).
-- Same content: gate registration by available = effective_balance - already_registered_count.

-- 1) register_for_class
