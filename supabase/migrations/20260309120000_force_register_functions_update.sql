-- Force-update register_for_class and register_for_class_monthly by dropping then creating.
-- Use when a previous migration was marked applied but the function body did not change.
