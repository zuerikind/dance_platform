...
export let state = {
    ...
    adminRevenueKpiExpanded: false,
    adminRevenueKpiPreset: 'summary',
    adminRevenueKpiGoal: '',
    adminRevenueKpiLoading: false,
    adminRevenueKpiResults: null,
    adminRevenueKpiError: null,
    adminRevenueKpiCache: {},
    ...
    settingsNotificationsExpanded: false,
    notificationsRecipientMode: 'all',
    notificationsSelectedIds: [],
    notificationsStudentSearch: '',
