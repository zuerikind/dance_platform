                ...
                <div class="student-private-classes-expandable ${myClassesExpanded ? "expanded" : ""}" style="margin-bottom: 1rem; border: 1px solid var(--border); border-radius: 16px; overflow: hidden;">
                    <div class="expandable-section-header" onclick="toggleExpandableNoRender('studentPrivateClasses')" style="display: flex; align-items: center; justify-content: space-between; padding: 12px 16px; cursor: pointer; background: var(--system-gray6);">
                        ...
                        <div style="display: flex; align-items: center; gap: 8px;" onclick="event.stopPropagation();">
                            <button type="button" class="btn-secondary" onclick="window.downloadCalendarIcs('student')" style="padding: 6px 12px; font-size: 12px; font-weight: 600;"><i data-lucide="download" size="14" style="vertical-align: middle; margin-right: 4px;"></i>${t22.export_calendar_ics || "Export .ics"}</button>
          ...
          return `
                    <div class="teacher-accepted-classes-expandable ${expanded ? "expanded" : ""}" style="padding: 0 1.2rem; margin-bottom: 1rem;">
                        <div class="admin-reg-header" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 0; border-bottom: 1px solid var(--border);">
                            ...
                            <button type="button" class="btn-secondary" onclick="event.stopPropagation(); window.downloadCalendarIcs('teacher');" style="padding: 6px 12px; font-size: 12px; font-weight: 600; border-radius: 8px; flex-shrink: 0;"><i data-lucide="download" size="14" style="vertical-align: middle; margin-right: 4px;"></i>${t2.export_calendar_ics || "Export .ics"}</button>
                        </div>
            ...
            return '<div style="display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 8px 0; border-bottom: 1px solid var(--border);">' + (l.status === "attended" ? '<span style="color: var(--system-green); font-size: 12px;"><i data-lucide="check-circle" size="14" style="vertical-align: middle;"></i> ' + (t2.checked_in || "Checked in") + "</span>" : "<div><strong>" + (studentName || "").replace(/</g, "&lt;") + "</strong> &middot; " + timeStr + '</div><div style="display: flex; gap: 6px;">' + (canCheckIn ? `<button type="button" class="btn-primary" style="padding: 6px 10px; font-size: 12px;" onclick="window.markPrivateLessonAttended('` + l.id + `')">` + (t2.check_in_btn || "Check in") + "</button>" : "") + (isPast && l.status === "confirmed" ? `<button type="button" class="btn-secondary" style="padding: 6px 10px; font-size: 12px;" onclick="window.markPrivateLessonNoShow('` + l.id + `')">` + (t2.mark_no_show_btn || "Mark no-show") + "</button>" : "") + "</div>") + "</div>";
          }).join("")}
                            </div>
                            ` : ""}
                            ${viewMode === "list" ? `
